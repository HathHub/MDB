...
namespace RoleplayCommands
{
    [Command("ooc")]
    [CommandSyntax("<text>")]
    public class CommandOoc : OpenMod.Core.Commands.Command
    {
        private readonly RoleplayCommands m_plugin;
        public CommandOoc(RoleplayCommands plugin,  IServiceProvider serviceProvider) : base(serviceProvider)
        {
            m_plugin = plugin;
        }
        ...
        protected override async Task OnExecuteAsync()
        {
            ...
            var config = m_plugin.config.Ooc;
