...
namespace RoleplayCommands
{
    [Command("mecanico")]
    [CommandSyntax("<text>")]
    public class CommandMecanico : OpenMod.Core.Commands.Command
    {
        private readonly RoleplayCommands m_plugin;
        public CommandMecanico(RoleplayCommands plugin,  IServiceProvider serviceProvider) : base(serviceProvider)
        {
            m_plugin = plugin;
        }
        ...
        protected override async Task OnExecuteAsync()
        {
            ...
            var config = m_plugin.config.Mecanico;
