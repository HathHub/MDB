...
namespace RoleplayCommands
{
    [Command("anon")]
    [CommandSyntax("<text>")]
    public class CommandAnon : OpenMod.Core.Commands.Command
    {
        private readonly RoleplayCommands m_plugin;
        public CommandAnon(RoleplayCommands plugin,  IServiceProvider serviceProvider) : base(serviceProvider)
        {
            m_plugin = plugin;
        }
        ...
        protected override async Task OnExecuteAsync()
        {
            ...
            var config = m_plugin.config.Anon;
