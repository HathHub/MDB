...
namespace RoleplayCommands
{
    [Command("policia")]
    [CommandSyntax("<text>")]
    public class CommandPolicia : OpenMod.Core.Commands.Command
    {
        private readonly RoleplayCommands m_plugin;
        public CommandPolicia(RoleplayCommands plugin,  IServiceProvider serviceProvider) : base(serviceProvider)
        {
            m_plugin = plugin;
        }
        ...
        protected override async Task OnExecuteAsync()
        {
            ...
            var config = m_plugin.config.Policia;
